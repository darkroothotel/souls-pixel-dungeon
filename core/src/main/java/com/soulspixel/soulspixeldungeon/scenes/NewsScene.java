...
import com.soulspixel.soulspixeldungeon.services.news.NewsArticle;
...
public class NewsScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnSite = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "read_more")){
			...
			protected void onClick() {
				super.onClick();
				String link = "https://www.reddit.com/r/PixelDungeon/new/";
				SoulsPixelDungeon.platform.openURI(link);
			}
		};
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			SoulsPixelDungeon.scene().addToFront(new WndArticle(article));
		}
	}
