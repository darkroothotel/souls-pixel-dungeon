...
import com.soulspixel.soulspixeldungeon.ui.ScrollPane;
import com.soulspixel.soulspixeldungeon.ui.StyledButton;
import com.soulspixel.soulspixeldungeon.ui.Window;
import com.soulspixel.soulspixeldungeon.ui.changelist.ChangeInfo;
import com.soulspixel.soulspixeldungeon.ui.changelist.WndChanges;
import com.soulspixel.soulspixeldungeon.ui.changelist.WndChangesTabbed;
import com.soulspixel.soulspixeldungeon.ui.changelist.souls_v0_1_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_1_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_2_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_3_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_4_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_5_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_6_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_7_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_8_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v0_9_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v1_X_Changes;
import com.soulspixel.soulspixeldungeon.ui.changelist.v2_X_Changes;
import com.soulspixel.soulspixeldungeon.windows.IconTitle;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				souls_v0_1_X_Changes.addAllChanges(changeInfos);
				break;
			case 1:
		...
		StyledButton btnSv1_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "1.X"){
			@Override
			protected void onClick() {
				super.onClick();
				if (changesSelected != 0) {
					changesSelected = 0;
					SoulsPixelDungeon.seamlessResetScene();
				}
			}
		};
		if (changesSelected != 0) btnSv1_X.textColor( Window.SPX_COLOR );
		btnSv1_X.setRect(list.left()-4f, list.bottom(), 21, changesSelected == 0 ? 19 : 15);
		addToBack(btnSv1_X);
		...
		if (changesSelected != 1) btn2_X.textColor( Window.SHPX_COLOR );
		btn2_X.setRect(btnSv1_X.right()-2, list.bottom(), 21, changesSelected == 1 ? 19 : 15);
		addToBack(btn2_X);
		...
		if (changesSelected != 2) btn1_X.textColor( Window.SHPX_COLOR );
		...
		if (changesSelected != 3) btn0_9.textColor( Window.SHPX_COLOR );
		btn0_9.setRect(btn1_X.right()-2, list.bottom(), 21, changesSelected == 3 ? 19 : 15);
		addToBack(btn0_9);
		...
		if (changesSelected != 4) btn0_8.textColor( Window.SHPX_COLOR );
		btn0_8.setRect(btn0_9.right()-2, list.bottom(), 21, changesSelected == 4 ? 19 : 15);
		addToBack(btn0_8);
		...
		if (changesSelected != 5) btn0_7.textColor( Window.SHPX_COLOR );
		btn0_7.setRect(btn0_8.right()-2, btn0_8.top(), 21, changesSelected == 5 ? 19 : 15);
		addToBack(btn0_7);
		...
		if (changesSelected != 6) btn0_6.textColor( Window.SHPX_COLOR );
		btn0_6.setRect(btn0_7.right()-2, btn0_8.top(), 21, changesSelected == 6 ? 19 : 15);
		addToBack(btn0_6);
		...
		if (changesSelected != 7) btnOld.textColor( Window.SHPX_COLOR );
		btnOld.setRect(btn0_6.right()-2, btn0_8.top(), 27, changesSelected == 7 ? 19 : 15);
		addToBack(btnOld);
	...
	public static void showChangeInfo(Image icon, String title, String... messages){
		Scene s = SoulsPixelDungeon.scene();
	...
	protected void onBackPressed() {
		SoulsPixelDungeon.switchNoFade(TitleScene.class);
	}
