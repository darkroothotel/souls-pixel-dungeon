...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		CreditsBlock gdx = new CreditsBlock(true,
				...
				"libGDX",
				Icons.LIBGDX.get(),
				"SoulsPD is powered by _libGDX_!",
				"libgdx.com",
				"https://libgdx.com/");
		if (landscape()){
		...
		CreditsBlock transifex = new CreditsBlock(true,
				...
				null,
				null,
				"SoulsPD is community-translated via _Transifex_! Thank you so much to all of Souls's volunteer translators!",
				"transifex.com/souls-pixel/...",
				"https://explore.transifex.com/souls-pixel/souls-pixel-dungeon/");
		...
		CreditsBlock freesound = new CreditsBlock(true,
				...
				null,
				null,
				"Souls Pixel Dungeon uses the following sound samples from _freesound.org_:\n\n" +
			...
			if (linkText != null && linkUrl != null){
				...
				linkButton = new PointerArea(0, 0, 0, 0){
					...
					protected void onClick( PointerEvent event ) {
						SoulsPixelDungeon.platform.openURI( linkUrl );
					}
				};
				add(linkButton);
			}
