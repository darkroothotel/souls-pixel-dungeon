...
import com.soulspixel.soulspixeldungeon.sprites.GnollGuardSprite;
...
import com.soulspixel.soulspixeldungeon.sprites.TormentedSpiritSprite;
...
public class v2_X_Changes {
	...
	public static void add_v2_3_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Thrown potions not clearing fire/ooze if they souls out of view\n" +
