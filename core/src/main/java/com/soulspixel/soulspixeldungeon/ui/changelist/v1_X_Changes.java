...
import com.soulspixel.soulspixeldungeon.effects.BadgeBanner;
import com.soulspixel.soulspixeldungeon.items.artifacts.SandalsOfNature;
import com.soulspixel.soulspixeldungeon.items.bombs.WoollyBomb;
...
import com.soulspixel.soulspixeldungeon.items.scrolls.exotic.ScrollOfAntiMagic;
...
import com.soulspixel.soulspixeldungeon.sprites.SpectralNecromancerSprite;
...
import com.soulspixel.soulspixeldungeon.ui.TalentIcon;
...
public class v1_X_Changes {
	...
	public static void add_v1_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.DARKSIGN), "new ankh mechanics",
