...
import com.soulspixel.soulspixeldungeon.actors.hero.abilities.Ratmogrify;
import com.soulspixel.soulspixeldungeon.actors.mobs.Bat;
import com.soulspixel.soulspixeldungeon.actors.mobs.Brute;
import com.soulspixel.soulspixeldungeon.actors.mobs.Crab;
import com.soulspixel.soulspixeldungeon.actors.mobs.DM100;
import com.soulspixel.soulspixeldungeon.actors.mobs.DM200;
...
import com.soulspixel.soulspixeldungeon.actors.mobs.Gnoll;
import com.soulspixel.soulspixeldungeon.actors.mobs.Golem;
import com.soulspixel.soulspixeldungeon.actors.mobs.Guard;
...
import com.soulspixel.soulspixeldungeon.actors.mobs.Rat;
import com.soulspixel.soulspixeldungeon.actors.mobs.RipperDemon;
import com.soulspixel.soulspixeldungeon.actors.mobs.Scorpio;
import com.soulspixel.soulspixeldungeon.actors.mobs.Shaman;
import com.soulspixel.soulspixeldungeon.actors.mobs.Skeleton;
import com.soulspixel.soulspixeldungeon.actors.mobs.Slime;
import com.soulspixel.soulspixeldungeon.actors.mobs.Snake;
import com.soulspixel.soulspixeldungeon.actors.mobs.Spinner;
import com.soulspixel.soulspixeldungeon.actors.mobs.Succubus;
import com.soulspixel.soulspixeldungeon.actors.mobs.Swarm;
...
public class AscensionChallenge extends Buff {
	...
	public static void processEnemyKill(Char enemy){
		...
		if (oldStacks > chal.stacks && Dungeon.hero.lvl == Hero.MAX_LEVEL){
			Dungeon.hero.earnSouls(Math.round(10*(oldStacks - chal.stacks)), chal.getClass(), null);
		}
	...
	public boolean act() {
		...
		if (stacks >= 8 && !Dungeon.bossLevel()){
			...
			if (damageInc >= 1){
				target.damage((int)damageInc, this, null);
