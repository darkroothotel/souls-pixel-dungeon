...
import com.soulspixel.soulspixeldungeon.sprites.GnollGeomancerSprite;
...
public class GnollGeomancer extends Mob {
				...
				reset( from, rockPath.collisionPos, new GnollGeomancer.Boulder(), new Callback() {
					...
					public void call() {
						...
						if (ch != null && !(ch instanceof GnollGeomancer)){
							ch.damage(Char.combatRoll(6, 12), new GnollGeomancer.Boulder(), DamageType.STRIKE);
	...
	public static class GnollRockFall extends DelayedRockFall{
		...
		public void affectChar(Char ch) {
			ch.damage(Char.combatRoll(6, 12), this, DamageType.STRIKE);
			if (ch.isAlive()) {
				Buff.prolong(ch, Paralysis.class, ch instanceof GnollGuard ? 10 : 3);
