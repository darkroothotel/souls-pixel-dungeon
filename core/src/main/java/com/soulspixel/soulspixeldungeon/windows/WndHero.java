...
public class WndHero extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public void initialize(){
			...
			IconButton infoButton = new IconButton(Icons.get(Icons.INFO)){
				...
				protected void onClick() {
					...
					if (SoulsPixelDungeon.scene() instanceof GameScene){
						...
						SoulsPixelDungeon.scene().addToFront(new WndHeroInfo(hero.heroClass));
					}
				}
			...
			statSlot( Messages.get(this, "stamina"), hero.STAMINA + "/" + hero.MAX_STAMINA);
			//statSlot( Messages.get(this, "poise"), hero.POISE + "/" + hero.POISE);
