...
public class WndEnergizeItem extends WndInfoItem {
	...
	public static void energize( Item item ) {
		...
		if (SoulsPixelDungeon.scene() instanceof AlchemyScene){
			...
			((AlchemyScene) SoulsPixelDungeon.scene()).createEnergy();
	...
	public static WndBag openItemSelector(){
		if (SoulsPixelDungeon.scene() instanceof GameScene) {
			...
			SoulsPixelDungeon.scene().addToFront(window);
			return window;
		}
	}
		...
		public void onSelect(Item item) {
			if (item != null) {
				...
				if (SoulsPixelDungeon.scene() instanceof GameScene) {
					...
					SoulsPixelDungeon.scene().addToFront(new WndEnergizeItem(item, parentWnd));
				}
			}
		}
	};
