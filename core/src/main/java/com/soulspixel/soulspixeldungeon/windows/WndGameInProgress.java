...
import com.soulspixel.soulspixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				SoulsPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				SoulsPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
