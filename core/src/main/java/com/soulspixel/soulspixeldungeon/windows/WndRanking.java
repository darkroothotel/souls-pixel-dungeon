...
import com.soulspixel.soulspixeldungeon.ui.BadgesGrid;
import com.soulspixel.soulspixeldungeon.ui.BadgesList;
import com.soulspixel.soulspixeldungeon.ui.Button;
import com.soulspixel.soulspixeldungeon.ui.CheckBox;
...
import com.soulspixel.soulspixeldungeon.ui.TalentButton;
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						SoulsPixelDungeon.scene().addToFront(new WndScoreBreakdown());
					}
				};
				...
				pos = statSlot(this, Messages.get(this, "gold"), num.format(Statistics.soulsCollected), pos);
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						SoulsPixelDungeon.scene().addToFront(new WndOptions(new Image(icon),
