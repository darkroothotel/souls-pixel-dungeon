...
import com.soulspixel.soulspixeldungeon.levels.rooms.standard.EmptyRoom;
import com.soulspixel.soulspixeldungeon.messages.Messages;
import com.soulspixel.soulspixeldungeon.sprites.CharSprite;
import com.soulspixel.soulspixeldungeon.sprites.MobSprite;
	...
	public static class Sentry extends NPC {
		...
		public void onZapComplete(){
			if (hit(this, Dungeon.hero, true)) {
				Dungeon.hero.damage(Char.combatRoll(2 + Dungeon.depth / 2, 4 + Dungeon.depth), new Eye.DeathGaze(), DamageType.MAGIC);
