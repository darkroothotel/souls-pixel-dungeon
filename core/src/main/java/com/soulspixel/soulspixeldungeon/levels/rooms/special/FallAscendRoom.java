...
public class FallAscendRoom extends SpecialRoom {
	...
	public void paint(Level level ) {
		...
		Painter.set( level, p, Terrain.DESCEND_FALL_BRANCH);
		level.transitions.add(new LevelTransition(level, c, LevelTransition.Type.DESCEND_FALL_BRANCH));
