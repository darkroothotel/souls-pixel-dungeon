...
package com.soulspixel.soulspixeldungeon.levels.features;
...
public class Chasm implements Hero.Doom {
	...
	public static void heroLand() {
		...
		hero.damage( Math.max( hero.HP / 2, Char.combatRoll( hero.HP / 2, hero.HT / 4 )), new Chasm(), Char.DamageType.FALL);
	}
