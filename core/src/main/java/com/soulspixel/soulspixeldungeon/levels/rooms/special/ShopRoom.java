...
import com.soulspixel.soulspixeldungeon.items.bags.PotionBandolier;
import com.soulspixel.soulspixeldungeon.items.bags.ScrollHolder;
import com.soulspixel.soulspixeldungeon.items.bags.VelvetPouch;
import com.soulspixel.soulspixeldungeon.items.bombs.Bomb;
import com.soulspixel.soulspixeldungeon.items.food.SmallRation;
...
import com.soulspixel.soulspixeldungeon.items.weapon.missiles.darts.TippedDart;
...
public class ShopRoom extends SpecialRoom {
	...
	protected void placeItems( Level level ){
		...
		if (!itemsToSpawn.isEmpty()){
			SoulsPixelDungeon.reportException(new RuntimeException("failed to place all items in a shop!"));
		}
