...
import com.soulspixel.soulspixeldungeon.actors.buffs.Shadows;
...
import com.soulspixel.soulspixeldungeon.items.Stylus;
...
import com.soulspixel.soulspixeldungeon.levels.features.HighGrass;
...
public abstract class Level implements Bundlable {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (version < SoulsPixelDungeon.v1_4_3){
	...
	public Mob createMob() {
		if (mobsToSpawn == null || mobsToSpawn.isEmpty()) {
			mobsToSpawn = Bestiary.getMobRotation(Dungeon.depth, Dungeon.branch);
		}
	...
	public Heap drop( Item item, int cell ) {
		...
		if (Dungeon.level != null && SoulsPixelDungeon.scene() instanceof GameScene) {
			pressCell( cell );
		}
	...
	public String tileName( int tile ) {
		...
		switch (tile) {
			...
			case Terrain.REVEALED_SECRET_ENTRANCE:
				return Messages.get(Level.class, "secret_entrance_name");
			case Terrain.REVEALED_SECRET_EXIT:
				return Messages.get(Level.class, "secret_exit_name");
			default:
	...
	public String tileDesc( int tile ) {
		...
		switch (tile) {
			...
			case Terrain.REVEALED_SECRET_ENTRANCE:
				return Messages.get(Level.class, "secret_entrance_desc");
			case Terrain.REVEALED_SECRET_EXIT:
				return Messages.get(Level.class, "secret_exit_desc");
			default:
				return "";
		}
	}
