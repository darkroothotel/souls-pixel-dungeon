...
public class Pasty extends Food {
	...
	protected void satisfy(Hero hero) {
		...
		switch(Holiday.getCurrentHoliday()){
			...
			case PD_BIRTHDAY:
				...
				hero.sprite.showStatusWithIcon(CharSprite.POSITIVE, Integer.toString(expToGive*100), FloatingText.SOUL);
				hero.earnSouls(expToGive*100, PotionOfExperience.class, null);
				break;
			case HALLOWEEN:
	...
	public String name() {
		switch(Holiday.getCurrentHoliday()){
			...
			case SHATTEREDPD_BIRTHDAY:
				return Messages.get(this, "souls_name");
			case HALLOWEEN:
	...
	public String info() {
		switch(Holiday.getCurrentHoliday()){
			...
			case SHATTEREDPD_BIRTHDAY:
				return Messages.get(this, "souls_desc");
			case HALLOWEEN:
