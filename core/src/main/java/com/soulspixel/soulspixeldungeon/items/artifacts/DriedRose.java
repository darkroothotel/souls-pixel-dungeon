...
package com.soulspixel.soulspixeldungeon.items.artifacts;
...
import com.soulspixel.soulspixeldungeon.scenes.CellSelector;
...
import com.soulspixel.soulspixeldungeon.windows.WndUseItem;
...
public class DriedRose extends Artifact {
	...
	public String desc() {
		if (!Ghost.Quest.completed()
				&& (SoulsPixelDungeon.scene() instanceof GameScene || SoulsPixelDungeon.scene() instanceof AlchemyScene)){
	...
	public static class GhostHero extends DirectableAlly {
		...
		protected boolean act() {
			...
			if (rose == null
				...
				damage(1, new NoRoseDamage(), DamageType.DARK_MAGIC);
			}
		...
		public void sayDarksign(){
			yell( Messages.get( this, "blessed_ankh_" + Random.IntRange(1, 3) ));
			Sample.INSTANCE.play( Assets.Sounds.GHOST );
		}

		public void sayHeroUndead(){
			yell( Messages.get( this, "undead_hero_" + Random.IntRange(1, 3) ));
			Sample.INSTANCE.play( Assets.Sounds.GHOST );
		}
