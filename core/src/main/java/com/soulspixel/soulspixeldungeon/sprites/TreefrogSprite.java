...
public class TreefrogSprite extends FrogSprite {

	public TreefrogSprite() {
		super();
		...
		prep.frames( frames, 58);

		stab = new Animation( 15, false );
		stab.frames( frames, 50, 51, 50, 52, 53, 52, 53, 48);

		leap = new Animation( 1, true );
		leap.frames( frames, 56);
