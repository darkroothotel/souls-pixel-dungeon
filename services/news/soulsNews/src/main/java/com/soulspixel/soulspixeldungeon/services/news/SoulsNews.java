...
package com.soulspixel.soulspixeldungeon.services.news;
...
public class SoulsNews extends NewsService {
	...
	public void checkForArticles(boolean useMetered, boolean preferHTTPS, NewsResultCallback callback) {
		...
		if (preferHTTPS) {
			httpGet.setUrl("https://soulspixel.com/feed_by_tag/SHPD_INGAME.xml");
		} else {
			httpGet.setUrl("http://soulspixel.com/feed_by_tag/SHPD_INGAME.xml");
		}
		...
		Gdx.net.sendHttpRequest(httpGet, new Net.HttpResponseListener() {
			...
			public void handleHttpResponse(Net.HttpResponse httpResponse) {
				...
				for (XmlReader.Element xmlArticle : xmlDoc.getChildrenByName("entry")){
					...
					article.title = xmlArticle.get("windows.wndrest.title");
					try {
