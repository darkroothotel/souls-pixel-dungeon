...
- Copy the code by pressing the green 'code' button on [this repository's main page](https://github.com/00-Evan/souls-pixel-dungeon), and then 'Download ZIP'. Unzip the downloaded zip to any directory on your computer you like.
...
To compile Souls Pixel Dungeon for desktop using this guide you will need:
...
- Set 'Gradle project' to 'souls-pixel-dungeon:desktop', and 'Tasks and arguments' to 'debug'
...
Note that these tools can also be used to generate platform-specific installers, but this functionality is unused in Souls Pixel Dungeon.