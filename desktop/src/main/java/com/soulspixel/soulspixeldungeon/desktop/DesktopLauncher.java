...
package com.soulspixel.soulspixeldungeon.desktop;
...
import com.soulspixel.soulspixeldungeon.services.news.NewsImpl;
import com.soulspixel.soulspixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.soulspixel.soulspixeldungeon.", "");
				...
				if (exceptionMsg.contains("Couldn’t create window")){
					TinyFileDialogs.tinyfd_messageBox(title + " Has Crashed!",
							title + " was not able to initialize its graphics display, sorry about that!\n\n" +
									...
									"If you are certain the game should work on your computer, please message the developer (darkroot776@gmail.com)\n\n" +
					...
					TinyFileDialogs.tinyfd_messageBox(title + " Has Crashed!",
							title + " has run into an error it cannot recover from and has crashed, sorry about that!\n\n" +
									"If you could, please email this error message to the developer (darkroot776@gmail.com):\n\n" +
									"version: " + Game.version + "\n" +
									exceptionMsg,
							"ok", "error", false);
				}
		...
		// (e.g. /.soulspixel/soulspixeldungeon), but we have too much existing save
		...
		new Lwjgl3Application(new SoulsPixelDungeon(new DesktopPlatformSupport()), config);
	}
}
