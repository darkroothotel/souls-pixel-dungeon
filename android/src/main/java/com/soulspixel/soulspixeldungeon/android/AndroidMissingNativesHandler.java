...
package com.soulspixel.soulspixeldungeon.android;
...
public class AndroidMissingNativesHandler extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String message = "SoulsPD failed to access some of its internal code and cannot start!\n\n" +
				"Try downloading the game from an official source if you haven't already. You can also screenshot this debug info and send it to the developer (darkroot776@gmail.com):";
